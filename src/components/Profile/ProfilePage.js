...
function ProfilePage() {
    ...
    useEffect(() => {
        if(currentProfile) {
            ...
            if(imgRef && currentProfile.url !== undefined) {
        ...
        <div className="profilePage">
            <div className="profilePage-header">
                <div className="profilePage-header-info">
                    <img src={currentProfile?.url ? currentProfile?.url : 'https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/271deea8-e28c-41a3-aaf5-2913f5f48be6/de7834s-6515bd40-8b2c-4dc6-a843-5ac1a95a8b55.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..BopkDn1ptIwbmcKHdAOlYHyAOOACXW0Zfgbs0-6BY-E'}
                        alt=""
            ...
            <Stack spacing={2} className="profilePage-stack">
                <div className="profilePage-comments">
                    ...
                    {currentComments.length === 0 ?
                        <div className="profilePage-stack-empty">
                            No comments found
                        </div>
                        : ''}
